...
The aim of this multivariate analysis is to investigate whether age, gender and HOXB6_1 methylation levels can serve as predictors of metastasis status (Primary vs Metastatic) in colorectal cancer patients. 
...
vif(model_2)
```
Once again, the low VIF scores suggest that multicollinearity is not present. HOXB6_1 methylation shows high predictive power (p=0.000105) for label_site_label, while label_age shows borderline significance.
