...
| Metriek                       | Getuned Logistisch Regressie Model | Getuned Random Forest Model |
| :---------------------------- | :-------------------------------- | :-------------------------- |
| **Beste Hyperparameters**     | `{'C': 100, 'penalty': 'l1', 'solver': 'liblinear'}` | `{'n_estimators': 300, 'min_samples_split': 10, 'min_samples_leaf': 1, 'max_features': 0.8, 'max_depth': 10}` |
| **Trainingsnauwkeurigheid**   | 1.00                               | 1.00                        |
| **Testnauwkeurigheid**        | **0.93**                           | **0.87**                    |
| **Classification Rapporten (Test Data):** |||
| **Colon_and_rectum_cancer Precisie** | 1.00                               | 0.87                        |
| **Colon_and_rectum_cancer Recall**   | 0.93                               | 0.90                        |
| **Colon_and_rectum_cancer F1-score** | 0.96                               | 0.88                        |
| **Lung_cancer Precisie**      | 0.86                               | 0.88                        |
| **Lung_cancer Recall**        | 1.00                               | 0.90                        |
| **Lung_cancer F1-score**      | 0.93                               | 0.89                        |
| **Stomach_cancer Precisie**   | 0.96                               | 0.88                        |
